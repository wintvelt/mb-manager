...
export const ContactFilters = (props) => {
	return (
		<SideNavDropDown chip={props.chip} title="Filters" icon="tune">
			...
			{(typeof props.MBFilter !== 'undefined') ?
				<li>
			...
			{(typeof props.selFilter !== 'undefined') ?
				<li>
					<div className="switch">
						<label>
							Alles tonen
			...
			{(typeof props.changeFilter !== 'undefined') ?
				<li>
					<div className='switch'>
						<label>
							Alles tonen
							<input type="checkbox"
								...
								checked={props.changeFilter}
								onChange={() => props.onChange({ type: "mut" })} />
							<span className="lever"></span>
							Alleen gewijzigd
						</label>
					</div>
