...
class ConnectionInt extends Component {
	...
	render() {
		const hasAccess = (this.props.accessObject);
		      ...
		      <div className="section">
		        ...
		        <div className="row">
		        	<ul className = "col offset-s1">
		        		{checkLi(this.props.accessObject, "Access Object is beschikbaar.",
		        ...
		        <div className="row">
		          <div className="col">
		            <span className="waves-effect waves-light btn"
		            	onClick={this.props.getRequestToken}>
		        ...
		        <div className="row valign-wrapper">
		          <div className="input-field col s11">
		            <input type="text" className="validate" 
		            	value={this.state.requestToken}
		            	onChange={this.onChange}
		            	/>
		            <label htmlFor="first_name">Plak Request token hier</label>
		          </div>
		          <div className="col">
		            <span className="waves-effect waves-light btn" 
		            	onClick={() => {
		            			this.props.setAccess(this.state.requestToken)}
		            		}>
		            		Inwisselen
            		</span>
		          </div>
