...
const secretKey = "795c98d7db73f34ff3bcdf69bcc495b7bbfa0b8b64fdd4160ecbc145362698c9";
...
export function getCustomFields() {
	return function(dispatch, getState) {
		...
		if (customFields && accessObject.access_token) {
			...
			return getData(url, accessObject.access_token)
			.then ( customFields => {
				dispatch(setCustomFields({ customFields: customFields, 
...
function postInitialData(url = '', data = {}, method="POST") {
